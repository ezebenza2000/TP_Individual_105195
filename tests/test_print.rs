...
mod test_print {
    ...
    fn test_dot_quote_multiple_whitespace() {
        let script = ".\" hello      world!\"";
        let script_file = "tests/test_dot_quote_multiple_whitespace.fth";
        let test_stack = "tests/stack_dot_quote_multiple_whitespace.fth";
        let test_stack_size = "stack-size={128000}";
    ...
    #[test]
    fn test_dot_quote_multiple() {
        let script = ".\" hello\"
    .\" world\"";
        let script_file = "tests/test_dot_quote_multiple.fth";
        let test_stack = "tests/stack_dot_quote_multiple.fth";
        let test_stack_size = "stack-size={128000}";
        ...
        assert_eq!(
            output, "helloworld",
            "Expected output to be 'helloworld', but got:\n{}",
            output
        );
    ...
    cr
    .\" world\"";
        let script_file = "tests/test_dot_quote_and_cr.fth";
        let test_stack = "tests/stack_dot_quote_and_cr.fth";
        let test_stack_size = "stack-size={128000}";
